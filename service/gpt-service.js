...
class GPTService {
  ...
  static async generateCategories(title) {
    ...
    try {
      ...
      const content = `Gere 10 categorias separadas por virgula, sem pular nenhuma linha, sem numerar, sem incluir #, por exemplo: minha categoria. Atualizadas com base nos interesses atuais baseadas nesse titulo: ${title}`;
  ...
  static async generateTags(title) {
    ...
    try {
      ...
      const content = `Gere 5 tags separadas por virgula, sem pular linhas, sem inserir #, ex: tag tal, atualizadas com base nos interesses atuais baseadas nesse titulo: ${title}`;
